...
const AddPatient = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try{
      const response=await fetch(`https://five-kilo-clinic-management-system-1.onrender.com/doctor/addpatient/${doctorId}`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div>
      <h1 className="font-extrabold text-5xl flex justify-center text-custom-unknown">Add Patient</h1>
      <div>
